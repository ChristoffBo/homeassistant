...
_LEX["tappit"].update({
    ...
    "action": [
        ...
        "smoke tyres", "bounce limiter", "backfire pop", "rev-off",
        "clutch kick", "gear slam", "panel bash", "boot slam", "mag spin",
        "sideways slide", "kickdown klap", "dyno pull", "strip race",
        "spar drag", "mine-dump dice", "CBD loop", "robot launch",
        "parking lot skid", "oil-slick spin", "skidmark lay", "two-step pop",
        "straight-line blast", "mirror flex", "spanner throw", "boot thump",
        "bonnet slam", "jack drop", "tow rope pull", "panel pop",
        "rev bounce show", "wheel wobble", "ratchet spin",
        "brandy sip and shift", "gear grind", "rev hold", "sidewalk dice",
        "median hop", "kerb scrape", "tyre squeal", "back alley drift",
        "handbrake yank", "race start jump", "gear flick", "window flex",
        "bronx stomp", "ref-limiter hug", "exhaust bark", "drag launch",
        "redline dance", "parking lot ref", "sound test", "sticker slap",
        "engine blip", "brake tap chirp", "brake fade flex", "donut smoke",
        "bonnet pop", "clutch stomp", "panel smack", "spar spin",
        "panel scratch", "roof tap", "spanner swing", "rev flood", "stall flex",
        "wheel wobble show", "mirror kick", "boot bounce", "fuel cut ref",
        "gear slap", "dyno spin", "mine dump slide", "spar shuffle",
        "exhaust bang", "ref roll", "robot jump", "brandy burn",
        "kick panel flex", "curb jump", "oil smoke puff", "handbrake lock",
        "spar row rev", "tyre smoke roll",
    ],
    ...
    "mood": [
        ...
        "Friday flex", "weekend mode", "Sunday dice blues", "payday power",
        "petrol light panic", "brake fade stress", "turbo high",
        "gear-grind grumpy", "late-night loud", "2am tappit", "CBD moody",
        "mall rat rage", "goldfields tired", "rust proud", "oil-stained chilled",
        "chop irritated", "cable-tie calm", "spar dice joy", "donut dizzy",
        "dyno proud", "track nervous", "strip strong", "robot anxious",
        "mine dump hyped", "exhaust proud", "ref limit happy",
        "speed bump moody", "tyre smoke jolly", "brandy strong", "coke buzzed",
        "Welkom wired", "stoep tired", "spietkop stressed", "rev proud",
        "weekend warrior", "month-end broke", "month-end dice happy",
        "parking lot proud", "panel gap worried", "rusty but fine",
        "exhaust angry", "muffler mellow", "brake fluid sad", "gearbox cranky",
        "handbrake happy", "clutch kick cheerful", "petrol proud",
        "bottle warm", "bronx comfy", "suspension moody", "low-and-slow chilled",
        "idle loopy", "noise proud", "sound system smug", "hubcap angry",
        "dyno nervous", "drag hyped", "brake squeal scared", "tyre proud",
        "Welkom happy", "CBD bored", "garage calm", "jack-stand grumpy",
        "mirror flex vain", "panel proud", "sparkplug jittery", "octane high",
        "fokwit furious", "boot bass proud", "tappit lekker", "stoep chilled",
        "dice ready", "werk tired", "chop moody", "night racer hyped",
        "bakkie chilled", "Welkenstein serious", "brake pad sad", "ref proud",
    ],
    ...
    "place": [
        ...
        "parking lot dyno", "backstreet drag strip", "Welkom Shell garage",
        "Welkom Total garage", "Welkom Sasol", "Engen Welkom", "Welkom taxi rank",
        "Welkom bus stop", "Welkom casino parking", "Welkom hospital robots",
        "Welkom rugby field", "Welkom high school lot", "Welkom township road",
        "Welkom mine gate", "Welkom traffic circle", "Welkom mall basement",
        "Welkom car wash", "Welkom scrapyard", "Welkom spares shop",
        "Welkom tyre fitment", "Welkom panel beater", "Welkom spray booth",
        "Welkom drag strip", "Welkom gravel road", "Welkom dirt lot",
        "Welkom koppie top", "Welkom cemetery road", "Welkom shebeen",
        "Welkom shisa nyama", "Welkom beer hall", "Welkom stadium lot",
        "Welkom police roadblock", "Welkom spietkop trap",
        "Welkom Riebeeckstad road", "Welkom Odendaalsrus road",
        "Welkom Virginia road", "Welkom Allanridge road",
        ...
        "Welkom park bench", "Welkom taxi bay", "Welkom stoep", "Welkom jol spot",
        "Welkom bottle store", "Welkom liquor shop", "Welkom scrapyard corner",
        "Welkom highway onramp", "Welkom offramp", "Welkom service road",
        "Welkom pitstop", "Welkom drag lane", "Welkom church lot",
        "Welkom Sunday market", "Welkom main taxi route", "Welkom short left",
        "Welkom kasi corner", "Welkom gold mine shaft",
    ],

    "gear": [
        "Bronx skoene", "wheelspanner", "spanner set", "2L brandy bottle",
        "cut exhaust", "rusty Cortina", "Uno with hole", "Citi Golf",
        "boot sound box", "cable ties bumper", "hubcap stash", "jack stand",
        "bottle jack", "dodgy radio", "amp and sub", "spare wheel", "flat mag",
        "rust patch kit", "ratchet set", "socket set", "cheap coil springs",
        "drop kit", "welkom sticker pack", "flame decal", "spoiler special",
        "mirror dice", "seat covers", "torn steering wheel", "rev counter",
        "aftermarket tach", "boost gauge", "oil gauge", "temp gauge",
        "fuel can", "jerry can", "tow rope", "jumper cables", "spar tyre pump",
        "welkom tyre weld", "cheap tool kit", "panel beater hammer",
        ...
        "welkom hoodie", "welkom cap", "welkom gloves", "welkom socks",
        "welkom toolkit bag", "dashboard cover", "aftermarket lights",
        "HID kit", "LED strip", "neon underglow", "boot spoiler", "roof rack",
        "bike rack", "welkom car mat", "cheap seatbelt clip",
        "welkom dice keychain", "lanyard", "cheap hooter",
    ],
})
# --- extra banks for riff templates (~100 each) ---
_LEX["tappit"].update({
    "thing": [
        "Golf", "Uno", "Citi", "Jetta", "diff", "clutch", "tyres", "exhaust",
        "sound system", "brake pads", "bonnet", "boot lid", "spoiler",
        "sticker pack", "neon light", "brake disc", "subwoofer", "amp",
        "gearbox", "fuel pump", "injector", "piston", "turbo", "radiator",
        "fender", "headlight", "mag wheel", "brake light", "handbrake",
        "rearview mirror", "windscreen", "sunroof", "quarter panel",
        "tow rope", "wheelspanner", "jack stand", "tyre iron", "spar tyre pump",
        "exhaust tip", "bonnet bra", "dash cover", "aftermarket hooter",
        "rev counter", "boost gauge", "oil gauge", "fuel gauge",
        "temp gauge", "Citi Golf door", "Uno bumper", "Jetta boot",
        "rust patch", "panel gap", "cable tie bumper", "brandy bottle",
        "beer crate", "spar chips packet", "mirror dice", "neon strip",
        "straight pipe", "muffler delete", "cut spring", "coilover",
        "cheap mag", "flat tyre", "slick tyre", "drag slick",
        "seatbelt clip", "dashboard cover", "welkom sticker",
        "flame decal", "spoiler special", "gear knob spinner",
        "alarm remote", "immobiliser chip", "bottle jack",
        "ratchet set", "socket set", "panel hammer", "cheap tool kit",
        "spar tyre weld", "plastic chair", "welkom hoodie", "bronx boots",
        "welkom cap", "welkom gloves", "welkom socks", "cheap seat cover",
        "welkom radio faceplate", "amp wires", "dodgy wiring",
        "engine mount", "welkom oil can", "fuel jerry can", "2-stroke mix",
        "brake fluid bottle", "panel scratch", "sparrow exhaust",
        "boot bass box", "spar ref slip", "tyre patch kit",
    ],

    "metric": [
        "ref count", "noise level", "smoke volume", "octane rating",
        "brake fade", "wheelspin ratio", "panel gap", "rust spots",
        "bass drop dB", "rev limiter hits", "tyre squeal length",
        "burnout smoke height", "drag time", "quarter-mile split",
        "stoep distance", "robot dice wins", "brandy intake",
        "beer count", "bronx grip factor", "Welkom ref index",
        "dyno graph lines", "speed bump clearance", "tow rope pulls",
        "panel beater bills", "spar parking dice count", "2am noise complaints",
        "cops stops", "spietkop bribes", "exhaust bangs per minute",
        "gear shifts", "clutch kicks", "donuts spun", "smoke rings",
        "boot bass beats", "amp watts", "subwoofer watts", "LED strip length",
        "neon glow brightness", "cheap mag wobble", "coilover drop mm",
        "cut spring bounce", "jack stand wobble", "rust penetration",
        "gearbox grinds", "fuel light trips", "petrol stops",
        "brake squeals", "hubcap losses", "mirror flex angle",
        "panel slap count", "stoep jol hours", "liquor shop runs",
        "tow truck calls", "gear knob spins", "dash lights dead",
        "exhaust leaks", "oil drips", "Welkenstein score",
        "spar receipt length", "burnout failures", "launch attempts",
        "tyre bursts", "spanner throws", "dyno lies", "ref frauds",
        "noise comp entries", "panel bash bruises", "spar rev pulls",
        "CBD loops", "mine dump slides", "robot jumps",
        "curb jumps", "stoep jol time", "drag lane attempts",
        "clutch stomps", "engine blips", "mirror kicks", "roof taps",
        "boot bounces", "stall flexes", "rev floods",
        "handbrake yanks", "sidewalk dices", "median hops",
        "skid marks laid", "kerb scrapes", "spar shuffles",
        "exhaust bangs", "ref rolls", "stoep drinks",
        "panel scratches", "stoep moers", "donut smokes", "tyre rolls",
    ],

    "verb": [
        "moer", "rev", "dice", "burn", "launch", "chirp", "spin", "drop",
        "slam", "skrrt", "klap", "kick", "smash", "pop", "bounce", "scrape",
        "flex", "squeal", "grind", "pull", "shift", "choke", "stall",
        "rattle", "hammer", "chirp tyres", "bounce limiter",
        "slam bonnet", "spin mags", "klap gears", "bash panel",
        "moer brakes", "throw spanner", "pump clutch", "snap cable tie",
        "stick decal", "flash neon", "rev flood", "kick panel",
        "yank handbrake", "chirp diff", "bang exhaust", "ref limiter hug",
        "pop bonnet", "stomp clutch", "lay skid", "pull tow rope",
        "chop gears", "slap sticker", "flex mirror", "bash bumper",
        "dice spietkop", "launch robot", "burn petrol", "smoke tyres",
        "spin donuts", "ref ref", "klap limiter", "chirp Bronx",
        "moer diff", "smash mag", "stall launch", "scrape sump",
        "grind gear", "slam door", "bounce seat", "shift short",
        "drop clutch", "chirp tyres", "burn rubber", "pop rev",
        "launch straight", "dice bru", "spin Uno", "smoke Jetta",
        "rev Citi", "moer Golf", "chirp Cortina", "slam bonnet",
        "bash spietkop", "smash exhaust", "stall start", "klap steering",
        "rattle door", "bang roof", "chirp diff", "scrape kerb",
        "flex bumper", "stomp pedal", "pull handbrake", "spin wheel",
        "launch curb", "burn stoep", "dice main road", "moer koppie",
    ],

    "adj_bad": [
        "kak", "dodgy", "cheap", "bliksemmed", "stuk-stuk", "budget",
        "half-arsed", "broke-ass", "sleg", "rotten", "rusty", "misaligned",
        "pap", "popped", "faded", "worn", "skew", "cracked", "loose",
        "flimsy", "bent", "off-balance", "leaky", "smoky", "noisy",
        "skelm", "broken", "rough", "crooked", "messed-up", "patched",
        "wobbly", "flaky", "slack", "cheapass", "bargain-bin", "DIY",
        "underpowered", "dead", "dying", "roasted", "seized",
        "sticky", "sagging", "cut-up", "botched", "fake", "drol",
        "mall-spec", "taxi-spec", "overheated", "oil-soaked",
        "dusty", "dirty", "spilled", "skid-marked", "loud", "ugly",
        "ge-tune", "misfire", "sputtering", "knocking", "pinging",
        "dented", "scratched", "paint-chipped", "patched-up",
        "patched-down", "pothole-damaged", "fuel-starved",
        "fokwit", "useless", "excessive", "oversprayed",
        "dodgy-fitment", "taxi-fitment", "spar-special",
        "panel-beater special", "brake-fade", "stoep-style",
        "off-idle", "fod", "lemon", "cheap flex",
        "trolley-sourced", "smoke-choked", "heat-soaked",
        "piss-poor", "handbrake-torn", "boot-bashed",
        "stoep-patched", "mall-polish", "spietkop-magnet",
    ],

    "adj_good": [
        "lekker", "brutal", "proper", "boss", "brutal-spec", "full-send",
        "stoep-approved", "welkom-spec", "ref-ready", "sharp", "crisp",
        "clean", "straight", "tight", "strong", "moerse", "mean",
        "loud", "savage", "brutalized", "tuned", "sorted", "bling",
        "chrome", "buffed", "flexed", "dyno-proven", "track-ready",
        "drag-ready", "burnout-proof", "octane-high", "rev-happy",
        "noise-champion", "torque-king", "speed-demon", "panel-tight",
        "spanner-sorted", "brandy-polished", "welkom-smooth",
        "boss-spec", "OG", "real-deal", "brutal-look", "savage-sound",
        "raw", "ref-worthy", "stoep-legend", "CBD-spec", "bru-spec",
        "proper tappit", "kitted", "blessed", "holy-noise",
        "mint", "showroom", "respray-fresh", "drop-top", "bagged",
        "slammed", "boosted", "turbo-fed", "NA-pride", "gearbox-tight",
        "rev-slick", "mag-clean", "burnout-boss", "drag-hero",
        "brutal-dyno", "panel-smooth", "stoep-king", "clutch-strong",
        "brake-tight", "steering-true", "alignment-straight",
        "OG ref-ref", "Citi-proud", "Uno-hero", "Golf-god",
        "Welkom whip", "stoep whip", "Sunday-proud", "donut-master",
        "skidmark-legend", "mine-dump-proven", "CBD-fresh",
        "panel-fresh", "boss-whip", "welkom-whip", "brandy-fresh",
        "tyre-tight", "stoep-proud", "moer-strong", "gearshift-king",
    ],
})
