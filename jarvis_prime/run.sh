...
#
# Jarvis Prime — Add-on image (updated with llama-cpp-python 0.3.16 for Phi-4 support)
#
...
RUN apt-get update && apt-get install -y \
    ...
    ansible sshpass iputils-ping \
 && rm -rf /var/lib/apt/lists/*

# ==========================================
# ADDITIVE BLOCK for backup_module + network tools + HTTPS stack
# ==========================================
RUN apt-get update && apt-get install -y --no-install-recommends \
    rsync cifs-utils nfs-common tar \
    net-tools arp-scan iproute2 dnsutils \
...
COPY /modules/backup_module.py /app/backup_module.py
